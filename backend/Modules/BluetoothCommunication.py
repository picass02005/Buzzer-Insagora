...
class BluetoothCommunication:
    ...
    async def send_command(self, command: bytes | str, args: bytes | str = b"", target_mac: bytes | str = None) -> bool:
        """
        ...
        :return: True if command got sent successfully
        """
        ...
        if len(args_format):
            msg_b = target_mac_format + command_format + b" " + args_format

        else:
            msg_b = target_mac_format + command_format
